...
:root {
  ...
  --sidebar-foreground: rgb(26, 26, 26);
  --sidebar-primary: rgb(0, 115, 255);
  --sidebar-primary-foreground: rgb(255, 255, 255);
  --sidebar-accent: rgb(232, 232, 232);
  --sidebar-accent-foreground: rgb(26, 26, 26);
  --sidebar-border: rgb(209, 209, 214);
  --sidebar-ring: rgb(0, 115, 255);
...
.dark {
  ...
  --chart-1: rgb(0, 115, 255);
  --chart-2: rgb(46, 204, 113);
  --chart-3: rgb(255, 69, 58);
  --chart-4: rgb(26, 26, 26);
  --chart-5: rgb(56, 56, 58);
  --sidebar: rgb(13, 13, 15);
  --sidebar-foreground: rgb(255, 255, 255);
  --sidebar-primary: rgb(0, 115, 255);
  --sidebar-primary-foreground: rgb(255, 255, 255);
  --sidebar-accent: rgb(26, 26, 26);
  --sidebar-accent-foreground: rgb(255, 255, 255);
  --sidebar-border: rgb(56, 56, 58);
  --sidebar-ring: rgb(0, 115, 255);
  --font-sans: Inter, ui-sans-serif, sans-serif, system-ui;
  --font-serif: Georgia, serif;
  --font-mono: SF Mono, ui-monospace, Menlo, Monaco, Consolas, monospace;
  ...
  --shadow-opacity: 0.3;
  --shadow-color: #000000;
  --shadow-2xs: 0px 3px 6px 0px hsl(0 0% 0% / 0.15);
  --shadow-xs: 0px 3px 6px 0px hsl(0 0% 0% / 0.15);
